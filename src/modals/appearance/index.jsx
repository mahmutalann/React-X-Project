...
import { useAppearance } from "~/store/apperance/hooks";
import { colors } from "~/utils/consts";
import { setBackgroundColor, setBoxShadow, setColor } from "~/store/apperance/actions";
	...
	return (
		<div className="w-[600px]">
			...
			<div className="p-8 pt-0">
				...
				These settings affect all X accounts in this browser.
				</p>
				<div className="mx-8 mb-4">
					<div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
						...
						<div className="flex-1 flex flex-col">
							...
							At the heart of X are text messages called posts, just like this one. Posts; photos, videos,
                            links, texts, tags etc. <Link className="text-[#1d9bf0] hover:underline"
																													to="/x">@X</Link> It may contain mentions such as.
							</div>
						</div>
					</div>
				</div>
